...
class MainForm(QtWidgets.QMainWindow):
    ...
    def setupUi(self):
        ...
        self.pB_zoomUp.clicked.connect(self.zoomUp)
        self.pB_zoomDown.clicked.connect(self.zoomDown)
        self.pB_perUp.clicked.connect(self.perUp)
        self.pB_perDown.clicked.connect(self.perDown)

    def resizeEvent(self, event):
        size = event.size()
        self.openGLWidget.resize(size.width() - 156, size.height() - 21)
    ...
    def ferum(self):
        ...
        gluSphere(object, SPHERE_RADIUS, 100, 100)
        ...
        glPushMatrix()
        glTranslate(0.0, 6.0, 6.0)
        gluSphere(object, SPHERE_RADIUS, 100, 100)
        glPopMatrix()

        glPushMatrix()
        glTranslate(6.0, 6.0, 6.0)
        gluSphere(object, SPHERE_RADIUS, 100, 100)
        glPopMatrix()

        glPushMatrix()
        glTranslate(6.0, 6.0, 0.0)
        gluSphere(object, SPHERE_RADIUS, 100, 100)
        glPopMatrix()
        ...
        glPushMatrix()
        gluCylinder(object, CYLINDER_RADIUS, CYLINDER_RADIUS, 6, 100, 100)
        glPopMatrix()
        ...
        # Диагональные линии
        glPushMatrix()
        glRotate(45, 0.0, 1.0, 0.0)
        glRotate(-35, 1.0, 0.0, 0.0)
        glRotate(45, 0.0, 0.0, 1.0)
        gluCylinder(object, CYLINDER_RADIUS, CYLINDER_RADIUS, 10, 100, 100)
        glPopMatrix()
